                        ...
                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-12">
                                                <div class="form-group">
                                                    <label for="customFile">Media (Cover Image) &nbsp;<span class="text-danger">(88 × 88
                                                        px)</span></label>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  id="first-name-column" class="form-control"" placeholder="Customer  Company Name" name="custcompany" >
                                                </div>
                                            </div>
