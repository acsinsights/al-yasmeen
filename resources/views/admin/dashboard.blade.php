                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-options">
                                    <a href="{{ route('admin.inbox') }}" class="btn btn-sm btn-primary">View All</a>
                                </div>
                            </div>
                                                ...
                                                <li class="mb-5 mt-5">
                                                    <div>
                                                        ...
                                                        <div class="activity-timeline-content">
                                                            <span
                                                                class="font-weight-normal1 fs-13">{{ $form->name }}</span><span
                                                                class="text-muted fs-12 float-end">{{ $form->email }}</span>
