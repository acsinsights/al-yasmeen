...
@section('page')
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="title-box-center">
                            <h2 class="title ser-title"> Transform Ordinary Places with <br> Our Fit Out Expertise!</h2>
    ...
    <section class="why-choose-us-style2-section bg-no-repeat bg-cover bg-pos-cb  "
        ...
        <div class="section-content">
            <div class="container">
                <div style="align-items: center;" class="service-sec service-sec-spacing row mrb-110" >
                    <div class="col-md-12 col-lg-12 col-xl-6 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="800ms"
                        ...
                        <h2 class="text-dark mrb-30 mrb-sm-30">
                            <span class="ser-sec-heading text-primary-color">Laboratory Solutions<br> </span>
                        </h2>
                ...
                <div style="align-items: center;" class="row service-sec-spacing mrb-110">
                    <div class="col-md-10 col-lg-10 col-xl-6 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="800ms"
                        style="visibility: visible; animation-duration: 800ms; animation-delay: 100ms; animation-name: fadeInUp;">
                        <div class="twentytwenty-wrapper twentytwenty-horizontal">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-6 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="800ms"
                        ...
                        <h5 class=" text-primary-color mrb-10"></h5>
                        <h2 class="text-dark mrb-30 mrb-sm-30">
                            <span class="ser-sec-heading text-primary-color">Datacenter Solutions<br> </span>
                        </h2>
                ...
                <div style="align-items: center;" class="service-sec service-sec-spacing row mrb-110" >
                    <div class="col-md-12 col-lg-12 col-xl-6 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="800ms"
                        ...
                        <h5 class="text-primary-color mrb-10"></h5>
                        <h2 class="text-dark mrb-30 mrb-sm-30">
                            <span class="ser-sec-heading text-primary-color">Audio-Video Solutions<br> </span>
                        </h2>
                ...
                <div style="align-items: center;" class="row service-sec-spacing mrb-110">
                    ...
                    <div class="col-md-12 col-lg-12 col-xl-6 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="800ms"
                        ...
                        <h5 class=" text-primary-color mrb-10"></h5>
                        <h2 class="text-dark mrb-30 mrb-sm-30">
                            <span class="ser-sec-heading text-primary-color">Fit Out Solution<br> </span>
                        </h2>
